...
public class Update extends javax.swing.JFrame {
    ...
    public Update() {
        initComponents();
         displayDataFromFile("gradebook_records.txt");
    }
private void saveDataToFile(String filePath) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filePath))) {
            ...
            if (jRadioButton1.isSelected()) {
                writer.write("1st Year\n");
            } else if (jRadioButton2.isSelected()) {
                writer.write("2nd Year\n");
            } else if (jRadioButton3.isSelected()) {
                writer.write("3rd Year\n");
            } else if (jRadioButton4.isSelected()) {
                writer.write("4th Year\n");
            }
            writer.write(jTextField3.getText() + "\n");
            writer.write("first Sem - " + jTextField4.getText() + "\n");
            writer.write("second Sem - " + jTextField5.getText() + "\n");
...
private void displayDataFromFile(String filePath) {
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            jTextField1.setText(reader.readLine());
            jTextField2.setText(reader.readLine());
            jComboBox1.setSelectedItem(reader.readLine());
            ...
            jTextField4.setToolTipText("GWA");
            String firstSemLine = reader.readLine();
            String secondSemLine = reader.readLine();

        // Extract only the numeric part using regular expressions
        String firstSem = firstSemLine.replace("1st Sem - ", "").replaceAll("[^\\d]", "");
        String secondSem = "";
        if (secondSemLine != null) {
            // Extract only the numeric part using regular expressions
            secondSem = secondSemLine.replace("2nd Sem - ", "").replaceAll("[^\\d]", "");
        }
        // Set the modified values to the text fields
        jTextField4.setText(firstSem);
        jTextField5.setText(secondSem);
    } catch (IOException e) {
        e.printStackTrace();
    }
}
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        saveDataToFile("gradebook_records.txt");
